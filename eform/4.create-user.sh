...
sudo sed -i "s/\(^eform.cli.createUser.filePath=\).*/\1$TMP_INSTALL_ESC\/create-user\/input\/Create_User_For_Tenant.xls/" 	$DEVOPS_HOME/tomcat/webapps/eform/WEB-INF/classes/application.properties

curl -G localhost:8300/eform/user/create-user